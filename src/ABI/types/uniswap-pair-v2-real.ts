...
export type ContractContext = EthersContractContextV5<
  UniswapPairV2Real,
  UniswapPairV2RealMethodNames,
  UniswapPairV2RealEventsContext,
  UniswapPairV2RealEvents
>;
...
export type UniswapPairV2RealEvents =
  | 'Approval'
  | 'Burn'
  | 'Mint'
  | 'Swap'
  | 'Sync'
  | 'Transfer';
export interface UniswapPairV2RealEventsContext {
...
export type UniswapPairV2RealMethodNames =
  | 'new'
  | 'DOMAIN_SEPARATOR'
  | 'MINIMUM_LIQUIDITY'
  | 'PERMIT_TYPEHASH'
...
export interface UniswapPairV2Real {
  /**
   * Payable: false
   * Constant: false
